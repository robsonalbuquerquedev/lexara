...
import { impactoCulturalLegadoArticles } from "@/data/impactoCulturalLegadoArticles";

export default function ImpactoCulturalLegadoCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    A marca deixada no público e no mercado. Aqui analisamos a
                    repercussão, a influência cultural e o legado de obras que
                    atravessam gerações, moldam comportamentos e redefinem
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {impactoCulturalLegadoArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
