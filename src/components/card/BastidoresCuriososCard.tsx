...
import { bastidoresCuriososCardArticles } from "@/data/bastidoresCuriososCardArticles";

export default function BastidoresCuriososCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Improvisos inesperados, decisões de produção arriscadas,
                    mudanças de roteiro e versões alternativas que transformaram
                    completamente o resultado final. Histórias reais que mostram
                    como o acaso também constrói a cultura geek.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {bastidoresCuriososCardArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
