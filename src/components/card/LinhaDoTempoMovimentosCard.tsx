...
import { linhaDoTempoMovimentosArticles } from "@/data/linhaDoTempoMovimentosArticles";

export default function LinhaDoTempoMovimentosCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Uma viagem cronológica pelos grandes movimentos culturais e
                    criativos. Entenda como cada era surgiu, evoluiu e deixou
                    marcas que ainda influenciam narrativas, estilos e ideias
                    até hoje.
                </p>
            </header>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {linhaDoTempoMovimentosArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
