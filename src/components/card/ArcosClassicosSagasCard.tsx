...
import { arcosClassicosSagasCardArticles } from "@/data/arcosClassicosSagasCardArticles";

export default function ArcosClassicosSagasCard() {
    return (
            ...
            <header className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl font-bold tracking-tight">
                        Arcos Clássicos & Sagas
                    </h2>
                </div>

                <p className="text-muted-foreground max-w-3xl">
                    Leituras e análises de arcos essenciais: histórias que redefiniram personagens,
                    mudaram o rumo de séries inteiras e viraram referência no gênero.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {arcosClassicosSagasCardArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
