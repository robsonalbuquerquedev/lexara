...
import { evolucaoCriativaArticles } from "@/data/evolucaoCriativaArticles";

export default function EvolucaoCriativaCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Estilos, linguagem e formatos não surgem prontos — eles
                    evoluem com o tempo. Aqui você entende como cada mudança
                    criativa reflete transformações culturais, tecnológicas e
                    sociais ao longo das gerações.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {evolucaoCriativaArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
