...
import { conexoesEntreUniversosArticles } from "@/data/conexoesEntreUniversosArticles";

export default function ConexoesEntreUniversosCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Pontes pouco conhecidas entre obras, inspirações cruzadas
                    e universos que dialogam entre si. Aqui você descobre
                    como ideias viajam entre filmes, séries, games, animes
                    e HQs — ampliando a leitura da cultura geek.
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {conexoesEntreUniversosArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
