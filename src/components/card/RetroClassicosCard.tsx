...
import { retroClassicosArticles } from "@/data/retroClassicosArticles";

export default function RetroClassicosCard() {
    return (
        <section className="max-w-6xl mx-auto px-6 py-16">
            ...
            <header className="mb-12">
                ...
                <p className="text-muted-foreground max-w-3xl">
                    Do 8-bit ao PS2: jogos que marcaram época, influenciaram o mercado
                    e ainda são referência hoje. Aqui você encontra análises sobre
                    design, inovação, impacto cultural e por que certos clássicos
                    envelhecem como vinho (e outros… como leite).
                </p>
            </header>

            {/* Cards */}
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {retroClassicosArticles.map((article) => (
                    <Link
                        key={article.id}
                        href={article.href}
